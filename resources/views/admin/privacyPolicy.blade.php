  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Gizlilik Politikası Sayfası Düzenleme</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                ...
                @endif
                <div class="form-group">
                  <label for="baslik"> Gizlilik Politikası Metni</label>
                  <textarea style="min-height: 200px;" name="aciklama" class="form-control" id="blogMetni" placeholder="Gizlilik Politikası Metninizi Girin">{{ $page->aciklama }}</textarea>
                </div>
            </div>
