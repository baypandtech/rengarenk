    ...
    <form action="/{!!Request::path()!!}" method="POST" enctype="multipart/form-data">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" name="urun_adi" class="form-control" id="exampleInputEmail1" placeholder="Ürün adı giriniz" value="{{ $products->baslik }}">
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Kısa Açıklama</label>
            <input type="text" name="aciklama" class="form-control" id="exampleInputEmail1" placeholder="Kısa açıklama giriniz" value="{{ $products->aciklama_kisa }}">
          </div>
        <div class="form-group">
          ...
          <div class="form-group">
            @if (!empty($products->image))
              <p class="text-center mt-3"><img id="old_image" src="/public/storage/{{ $products->image }}" alt="" srcset=""  class="page_detail_image"></p>
            @endif
          </div>
