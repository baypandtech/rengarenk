    ...
    <form action="/{!!Request::path()!!}" method="POST" enctype="multipart/form-data">
      ...
      <div class="card-body">
        <div class="form-group">
          ...
          <input type="text" name="baslik" class="form-control" id="exampleInputEmail1" placeholder="Hizmet adı giriniz" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Kısa Açıklama</label>
            <input type="text" name="aciklama" class="form-control" id="exampleInputEmail1" placeholder="Kısa açıklama giriniz">
          </div>
        <div class="form-group">
